...
@foreach ($produits as $produit)
    <tr>
        ...
        <td>
            ...
            @if($produit->status=="inactive")
               <a class="btn btn-success" onclick="return confirm('voulez vous vraiment activer ce produit ?')" href="{{route('admin.produits.active',$produit->id)}}"><i class="bi bi-check2"></i></a>
            @endif
        </td>
    </tr>
@endforeach
